...
(function () {
  const PSC_DATA = {
    series: [
      ...
      { rank: 16, display_name: "Hy2.0 Thinking",        thresholds: [0.6,0.65,0.7,0.75,0.8,0.85,0.9,0.95,1.0], task_pass_rates: [60.99,51.28,44.61,37.20,29.47,21.65,14.65, 9.22, 8.40], avg: 62.90, highlight: false },
